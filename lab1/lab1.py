...
# обираємо оптимальну за значенням змінну k (наприклад: 100)
# оскільки наші y[i] близькі за значенням до 100, проте yET менше за 100. 
# Ця змінна необхідна для пошуку найближчого "справа" значення до yET, тобто найближчого більшого за нього.
k = 100
